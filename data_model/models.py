...
from data_model.enums import SourceType, AwsRegionType
...
class Dataset(models.Model):
    ...
    source_uri = models.CharField(blank=False, null=False, max_length=32,
                                  help_text='Give Amazon Resource Name (ARN) if source_type is S3')
...
def get_unprocessed_keys(user: User, dataset: Dataset, n: int):
    processed_keys = already_processed_keys(user, dataset)
    unprocessed_keys = list(set(processed_keys + dataset.source_keys))
